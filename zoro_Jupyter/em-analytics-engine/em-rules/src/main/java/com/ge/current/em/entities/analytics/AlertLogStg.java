...
public class AlertLogStg implements Serializable {
    ...
    public String toString() {
        return "AlertLogStg{" + "time_bucket='" + time_bucket + '\'' + ", enterprise_uid='" + enterprise_uid + '\''
                + ", resrc_uid='" + resrc_uid + '\'' + ", alert_ts=" + alert_ts + ", resrc_type='" + resrc_type + '\''
                + ", alert_type='" + alert_type + '\'' + ", alert_name='" + alert_name + '\'' + ", severity='"
                + severity + '\'' + ", site_uid='" + site_uid + '\'' + ", segment_uid='" + segment_uid + '\''
                + ", segment_name='" + segment_name + '\'' + ", segment_type='" + segment_type + '\'' + ", asset_uid='"
                + asset_uid + '\'' + ", asset_type='" + asset_type + '\'' + ", rule_uid='" + rule_uid + '\'' + ", tags="
                + tags + ", measures=" + measures + ", ext_props=" + ext_props + '}';
    }
}
